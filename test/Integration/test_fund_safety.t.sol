...
contract FundSafetyTest is Test {
    ...
    function test_MultipleConcurrentSessions_BalancesCorrect() public {
        ...
        vm.warp(startTime + 1);
        vm.prank(host);
        marketplace.submitProofOfWork(s1, 1000, bytes32(uint256(0x1)), "QmProof1", "");
        ...
        vm.prank(host);
        marketplace.submitProofOfWork(s2, 1000, bytes32(uint256(0x2)), "QmProof2", "");
        ...
        vm.prank(host2);
        marketplace.submitProofOfWork(s3, 1000, bytes32(uint256(0x3)), "QmProof3", "");
    ...
    function test_SessionTimeout_CorrectDistribution() public {
        ...
        vm.warp(startTime + 1);
        vm.prank(host);
        marketplace.submitProofOfWork(sessionId, 1000, bytes32(uint256(0x1234)), "QmProof", "");
